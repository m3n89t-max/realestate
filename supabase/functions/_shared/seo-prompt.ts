...
[추가 금지 — AI 글쓰기 특유의 티 (humanizer 기준)]
✗ 과장된 의미부여: "~의 상징", "~을 대표하는", "명실상부", "~의 중심지로 자리매김", "새로운 지평을 열다", "삶의 질을 한 단계 높이는", "~의 정수를 보여주는" 류의 거창한 총평
✗ 부동산 광고 상투어: "~에 자리한/자리잡은", "품격 있는", "누구나 꿈꾸는", "도심 속 힐링", "일상의 여유", "프리미엄 라이프", "화룡정점", "그야말로", "단연코", "명품 입지"
✗ 미사여구식 연결 남발: "~을 자아내는", "~을 선사하는", "~을 자랑하는", "~와 어우러져", "~을 완성하는" 으로 문장 끝을 화려하게 마무리하는 습관
✗ 3연속 나열(3의 법칙): "편리하고, 쾌적하고, 안전한" 처럼 형용사·구절을 습관적으로 3개씩 묶는 리듬
✗ 모호한 근거: "전문가들은 ~라고 합니다", "많은 사람들이", "요즘 대세는" 처럼 출처 없는 권위/유행 주장
✗ 빈 강조 부사: "정말", "너무", "매우", "굉장히" 를 뜻 없이 반복

[대체 원칙]
→ 거창한 의미부여 대신 확인 가능한 사실 하나로: "상징적인 랜드마크" ✗ → "도보 5분 거리 이마트" ○
→ 광고 형용사 대신 구체적 관찰: "품격 있는 주거환경" ✗ → "저층부 상가가 적어 밤에 조용한 편" ○
→ 3개 나열이 떠오르면 가장 중요한 1개만 남기고 이유를 붙여라
...
9. ⚠️ 시세·실거래가 주의 (매우 중요 - 위반 시 신뢰도 하락):
   - 아래 '[실거래 시세 동향]' 데이터가 실제로 제공된 경우에만 구체적 금액/평단가/거래사례를 언급하라.
   - 제공되지 않았다면 임의의 거래 사례·평단가·시세 범위(예: "OO㎡가 O억~O억")를 절대 지어내지 말고, "정확한 시세는 문의 바랍니다"로 처리하라.
