...
[비디오 스크립트 구조 - 6~10장면, 각 장면은 무조건 5초 표기]
- 모든 장면(scene)의 duration_sec는 **반드시 숫자 5** (5초)로 고정 작성하세요.
- 장면1: Hook - 시청자가 멈춰보게 만드는 강렬한 오프닝 (5초)
- 장면2-5: 매물 핵심 소개, 입지 장점, 내부 특징 등 (각 5초)
- 마지막 장면: CTA (전화/문의 유도) (5초)
- 전체 길이는 장면 수 * 5초로 계산됩니다.
