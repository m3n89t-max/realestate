...
{"titles": ["제목1", "제목2", "제목3", "제목4", "제목5"]}`
    ...
    const ctx: BlogPromptContext = {
      ...
      commercial_grade: location?.commercial_grade,
      commercial_type: location?.commercial_type,
      foot_traffic: location?.foot_traffic,
      recommended_industries: location?.recommended_industries,
      price_trend: location?.price_trend,
      land_use_summary: location?.land_use_summary,
      style,
      tone,
      format,
      focus,
